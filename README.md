...
> 面向企业的物联网设备管理平台 —— 一个用 Go + Vue3 构建的开箱即用型 IoT PaaS，覆盖设备接入、物模型、遥测时序存储、规则引擎、告警、OTA、开放平台与可视化大屏。

> 📖 **第三方开发者请阅读 [docs/ 设备接入协议文档](docs/index.md)**（MQTT / TCP-DTU / HTTP 接入、物的模型、OpenAPI 签名、OTA 的完整报文格式与示例代码）。

---

## 目录

- [面向开发者：设备接入协议文档](docs/index.md)
- [一、架构总览](#一架构总览)
- [二、核心特性](#二核心特性)
- [三、快速开始](#三快速开始)
- [四、设备接入](#四设备接入)
